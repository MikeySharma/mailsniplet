...
<template>
    <main class="flex gap-4 min-h-screen">
        <aside class="w-[20em] bg-gray-800 text-white p-2 flex flex-col">
            ...
            <UButton block @click="signOut({ callbackUrl: '/auth/login' })" class="mt-auto" color="gray" variant="solid">
                Logout
            </UButton>
        ...
        <aside class="min-w-[4em] lg:w-[7em] w-[5em] bg-gray-700 p-2">
            <div class="flex items-center flex-col gap-3">
                <a href="https://internetl.ink/static_html/web_user_settings.html"
                    class="text-decoration-none text-reset px-1 w-full" data-bs-trigger="hover" data-bs-placement="left" data-bs-toggle="tooltip" data-bs-title="Click to navigate to Setting page" >
                    <img alt="settings" src="https://internetl.ink/static_html/icons/icon_settings_pink.svg" />
                </a>
                <a href="#" class="text-decoration-none text-reset px-1 w-full" data-bs-trigger="hover" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Click to hide quick-pick bar">
                    <img alt="down-arrow" src="https://internetl.ink/static_html/icons/icon_v_down_pink.svg" />
                </a>
                <!-- different mode -->
                <div class="btn-group dropstart">
                    <button type="button" class="btn btn-icon p-0 text-decoration-none text-reset" id="modeToggleMenu"
                        ...
                        <img src="https://internetl.ink/static_html/icons/icon_colour_flower.svg"
                            class="main-img-mode w-full" alt="Theme Mode" />
                    </button>
                    <ul class="dropdown-menu dropdown-mode dropdown-menu-dark text-center" aria-labelledby="modeToggleMenu">
                        <li>
                        ...
                        <li>
                            <span class="dropdown-item dropdown-item-mode" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                data-bs-placement="left" data-mode="2" data-bs-title="Click to activate Dark Mode 2">
                        ...
                        <li>
                            <span class="dropdown-item dropdown-item-mode" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                data-bs-placement="left" data-mode="3" data-bs-title="Click to activate Dark Mode 3" id="3">
                        ...
                        <li>
                            <span class="dropdown-item dropdown-item-mode" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                data-bs-placement="left" data-mode="4" data-bs-title="Click to activate Dark Mode 4">
                ...
                <div class="btn-group dropstart">
                    <a href="#" class="btn btn-icon p-0 text-decoration-none text-reset" data-bs-toggle="dropdown"
                        ...
                        <img src="https://internetl.ink/static_html/icons/ew_favicon_dark_1.svg"
                            class="main-img-favicon w-full" alt="Favicon Type" />
                    </a>
                    <ul class="dropdown-menu dropdown-mode dropdown-menu-dark text-center">
                        <li>
                            <a class="dropdown-item dropdown-item-favicon" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                data-bs-placement="left" data-mode="1" data-bs-title="Click to activate Dark Favicon 1">
                        ...
                        <li>
                            <a class="dropdown-item dropdown-item-favicon" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                data-bs-placement="left" data-mode="2" data-bs-title="Click to activate Dark Favicon 2">
                        ...
                        <li>
                            <a class="dropdown-item dropdown-item-favicon" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                data-bs-placement="left" data-mode="3" data-bs-title="Click to activate Dark Favicon 3"
                                id="3">
                        ...
                        <li>
                            <a class="dropdown-item dropdown-item-favicon" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                data-bs-placement="left" data-mode="4" data-bs-title="Click to activate Dark Favicon 4">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark text-center">
                        ...
                        <li>
                            <a class="dropdown-item dropdown-item-1" href="#" data-bs-toggle="tooltip"
                                ...
                                <img class="w-full p-1" src="https://internetl.ink/static_html/icons/icon_mobile_pink.svg"
                ...
                <div class="btn-group dropstart">
                    <a href="#" class="btn btn-icon p-0 text-decoration-none text-reset" data-bs-toggle="dropdown"
                        ...
                        <img alt="Menu Position" src="https://internetl.ink/static_html/icons/icon_menu_left_pink.svg"
                            class="main-img-2 w-full" />
                    </a>
                    <ul class="dropdown-menu dropdown-menu-dark text-center">
                        <li>
                            <a class="dropdown-item dropdown-item-2 active" href="#" data-bs-toggle="tooltip"
                                data-bs-placement="left" data-bs-custom-class="custom-tooltip"
                                data-bs-title="Menu Position Right">
                                <img class="w-full p-1"
                                    src="https://internetl.ink/static_html/icons/icon_menu_right_pink.svg" alt="Menu Right"
                                    data-menu-type="right" />
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item dropdown-item-2" href="#" data-bs-toggle="tooltip"
                                data-bs-placement="left" data-bs-custom-class="custom-tooltip"
                                data-bs-title="Menu Position Top">
                                <img class="w-full p-1" src="https://internetl.ink/static_html/icons/icon_menu_top_pink.svg"
                        ...
                        <li>
                            <a class="dropdown-item dropdown-item-2" href="#" data-bs-toggle="tooltip"
                                ...
                                <img class="w-full p-1"
                                    src="https://internetl.ink/static_html/icons/icon_menu_left_pink.svg" alt="Menu Left"
                                    data-menu-type="left" />
                            </a>
                        </li>
                    </ul>
                ...
                <div class="btn-group dropstart">
                    <a href="#" class="btn btn-icon p-0 text-decoration-none text-reset" data-bs-toggle="dropdown"
                        aria-expanded="false">
                        <img src="https://internetl.ink/static_html/icons/icon_aa_pink.svg" class="main-img-family w-full"
                            alt="Font Family" />
                    </a>
                    <ul class="dropdown-menu dropdown-menu-dark text-center">
                        <li>
                            <a class="dropdown-item dropdown-item-family" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                data-bs-placement="left" data-mode="lato_regular"
                                data-bs-title="Click to activate Lato Regular">
                                <span data-mode="lato_regular">Lato Regular</span>
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item dropdown-item-family" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                data-bs-placement="left" data-mode="roboto" data-bs-title="Click to activate Roboto">
                                <span data-mode="roboto">Roboto</span>
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item dropdown-item-family" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                data-bs-placement="left" data-mode="open_sans" data-bs-title="Click to activate Open Sans"
                                id="3">
                                <span data-mode="open_sans">Open Sans</span>
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item dropdown-item-family" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                data-bs-placement="left" data-mode="montserrat"
                                data-bs-title="Click to activate Montserrat">
                                <span data-mode="montserrat">Montserrat</span>
                            </a>
                        </li>
                    </ul>
                </div>
                    ...
                    <ul class="dropdown-menu dropdown-font dropdown-menu-dark text-center">
                        ...
                        <li>
                            <a class="dropdown-item dropdown-item-fonts-current dropdown-item-fonts active"
                                ...
                                <span class="main-font-size li" style="font-size: 4em !important; padding: 0px 15px;">18</span>
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item dropdown-item-fonts" id="plus_1" href="#" data-font-correction="+1"
                                ...
                                <img class="w-full p-1" src="https://internetl.ink/static_html/icons/icon_plus_one_pink.svg"
                                    alt="" />
                            </a>
                        </li>
                ...
                <!-- split_screen-->
                <a href="#" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Click to toggle split srceen"
                    data-bs-trigger="hover" class="text-decoration-none text-reset" @click="splitScreen()">
                    <img class="w-full p-1" src="https://internetl.ink/static_html/icons/icon_single_pane_pink.svg"
                        alt="split_screen" />
                </a>
            </div>
        </aside>
